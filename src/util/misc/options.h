...
#define OPTIONS \
  ...
  OPTION (lightrestart, 0, 0, 1, "enable light restarts") \
  OPTION (lightrestart_condition, 1, 0, 1, "enable light restarts condition") \
  ...
  OPTION (mab_chb, 1, 0, 1, "enable chb in mab") \
  OPTION (mab_enable, 1, 0, 1, "enable_mab") \
  OPTION (mab_lrb, 0, 0, 1, "enable lrb in mab") \
  OPTION (mab_vsids, 1, 0, 1, "enable vsids in mab") \
