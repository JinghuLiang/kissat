...
\
  ...
  COUNTER (light_restarts, 1, PCNT_RESTARTS, "%", "light_restarts") \
  ...
  COUNTER (mab_chb, 1, PCNT_MAB_RESTARTS, "%", "selected chb in mab") \
  COUNTER (mab_lrb, 1, PCNT_MAB_RESTARTS, "%", "selected lrb in mab") \
  COUNTER (mab_restarts, 1, PCNT_STABLE_RESTARTS, "%", "mab restart") \
  COUNTER (mab_valid_switch, 1, PCNT_MAB_RESTARTS, "%", "heuristic switch") \
  COUNTER (mab_vsids, 1, PCNT_MAB_RESTARTS, "%", "selected vsids in mab") \
  METRIC (moved, 1, PCNT_MAB_REDUCTIONS, "%", "reductions") \
  ...
  COUNTER (stable_decisions, 1, PCNT_DECISIONS, "%", "decisions") \
  METRIC (stable_modes, 2, CONF_INT, "", "interval") \
  COUNTER (stable_propagations, 1, PCNT_PROPS, "%", "propagations") \
  COUNTER (stable_restarts, 1, PCNT_RESTARTS, "%", "restarts") \
  COUNTER (stable_conflicts, 1, PCNT_CONFLICTS, "%", "restarts") \
