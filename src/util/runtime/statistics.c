...
#include "resources.h"
#include "../data-structures/tiers.h"
...
#define PCNT_STABLE_RESTARTS(NAME) \
  PERCENT (NAME, stable_restarts)

#define PCNT_MAB_RESTARTS(NAME) \
  PERCENT (NAME, mab_restarts)

#define PCNT_MAB_REDUCTIONS(NAME) \
  PERCENT (NAME, reductions)
