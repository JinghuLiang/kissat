...
#include "../runtime/allocate.h"  // Use 'kissat' allocator if embedded.
#include "../runtime/error.h"     // Use 'kissat_fatal' if embedded.
#include "../../core/main/internal.h"  // Also use 'kissat' statistics if embedded.
#include "../runtime/terminate.h" // For macros defining termination macro.
